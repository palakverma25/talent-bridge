...
export default function SignUpPage() {
  ...
  const onSubmit = async (formData: FormData) => {
    ...
    setMessage(error ? error.message : "Account created. Complete onboarding to pick your role.");
  };
  ...
  return (
    <div className="mx-auto max-w-md rounded-xl border border-zinc-200 bg-white p-6">
      ...
      <form action={onSubmit} className="mt-4 space-y-3">
        ...
        <button className="w-full rounded-md bg-zinc-900 px-4 py-2 text-sm font-medium text-white">Sign up</button>
      </form>
